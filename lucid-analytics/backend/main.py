...
Integra Meta Ads + LucidBot para calcular CPA real por anuncio
"""
...
from routers import auth, meta, lucidbot, analytics
...
app = FastAPI(
    ...
    description="Dashboard de métricas Meta Ads + LucidBot para calcular CPA real",
    version="1.0.0",
    lifespan=lifespan
)
