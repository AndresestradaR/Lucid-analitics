...
async def get_dashboard(
    ...
    # Filtrar anuncios que tienen leads o ventas
    ...
    return {
        ...
        "top_performers": ads_with_data[:5],
        "date_range": {
            "start": start_date,
            "end": end_date
        }
...
async def get_ad_analytics(
    ...
    # Obtener datos de LucidBot con detalles de contactos
    lucid_data = await get_lucidbot_contacts_by_ad(lucidbot_token, ad_id)
...
async def get_quick_stats(
    ...
    Para mostrar tendencias en el dashboard
    """
