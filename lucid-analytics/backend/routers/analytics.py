...
# Offset de timezone Colombia (UTC-5)
...
def is_date_in_range(date_str: str, start_date: str, end_date: str) -> bool:
    ...
    try:
        # Inicio del día - RESTAR 5 horas para compensar UTC vs Colombia
        # Si usuario pide 13/dic, buscamos desde 12/dic 19:00 UTC
        start = datetime.strptime(start_date, "%Y-%m-%d") - timedelta(hours=COLOMBIA_UTC_OFFSET_HOURS)
        
        # Fin del día (23:59:59) + SUMAR 5 horas para compensar
        # Si usuario pide 13/dic, buscamos hasta 14/dic 04:59 UTC
        end = datetime.strptime(end_date, "%Y-%m-%d").replace(hour=23, minute=59, second=59) + timedelta(hours=COLOMBIA_UTC_OFFSET_HOURS)
    ...
    async with httpx.AsyncClient() as client:
        ...
        return {
            ...
            "_debug": {
                ...
                "timezone_offset_applied": COLOMBIA_UTC_OFFSET_HOURS
            }
        }
