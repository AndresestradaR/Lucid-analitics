...
from utils import get_current_user, encrypt_token, decrypt_token
...
async def get_ads(
    ...
    async with httpx.AsyncClient() as client:
        ...
        for ad in ads:
            ...
            insights_params = {
                "access_token": access_token,
                "fields": "spend,impressions,clicks,ctr,cpm,cpc,reach,frequency",
...
async def get_ad_details(
    ...
    async with httpx.AsyncClient() as client:
        ...
        ad_params = {
            "access_token": access_token,
            "fields": "id,name,status,creative{thumbnail_url,body,title}"
        }
