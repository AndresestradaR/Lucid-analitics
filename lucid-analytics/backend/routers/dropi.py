...
async def get_wallet_history(
    ...
    total_fletes = 0     # Solo "SALIDA POR COBRO DE FLETE INICIAL"
    
    # Diccionario para agrupar por día
    daily_data = {}
    daily_dropshipping = {}  # Para el gráfico de ganancias vs fletes
    ...
    try:
        ...
        while current_day <= end_dt:
            ...
            daily_dropshipping[day_key] = {"ganancias": 0, "fletes": 0, "date": day_key}
    ...
    for record in records:
        try:
            ...
            if mov_type == "ENTRADA":
                ...
                # Detectar cobros de flete
                if "SALIDA POR COBRO DE FLETE INICIAL" in description:
                    total_fletes += amount
                    if day_key in daily_dropshipping:
                        daily_dropshipping[day_key]["fletes"] += amount
    ...
    print(f"[WALLET HISTORY] Dropshipping: ganancias={total_ganancias}, fletes={total_fletes}")
    ...
    return {
        ...
        "dropshipping": {
            ...
            "utilidad_neta": total_ganancias - total_fletes,
